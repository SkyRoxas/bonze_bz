...
$('.menu-block_main-menu .menu-block-wrapper > .menu').append($('#block-locale-language'));
//$('.menu-block_main-menu .menu-block-wrapper > .menu').append($('#block-locale-language'));
$('.menu-block_main-menu .menu-block-wrapper > .menu').find('#block-locale-language').wrap('<li class ="menu__item"></li>');
  ...
  menu_item_hover('.menu-block_main-menu .menu-block-wrapper >.menu', 'li.menu__item', '.active');
